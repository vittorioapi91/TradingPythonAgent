...
- `.vscode/fundamentals/launch.json` - EDGAR downloader configurations
- `.vscode/macro_model/fred/launch.json` - FRED data downloader configurations
- `.vscode/macro_model/bls/launch.json` - BLS data downloader configurations
- `.vscode/macro_model/eurostat/launch.json` - Eurostat data downloader configurations
- `.vscode/macro_model/imf/launch.json` - IMF data downloader configurations
...
1. Edit the appropriate component's `launch.json` file
